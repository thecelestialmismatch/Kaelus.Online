...
const faqs = [
  ...
  { q: "How long does compliance take?", a: "Timelines vary based on your current posture. Most organizations achieve CMMC Level 2 readiness in 3-6 months with Hound Shield. Our platform identifies gaps instantly and provides a prioritized remediation roadmap." },
  { q: "Do I need a C3PAO assessment?", a: "Yes, CMMC Level 2 certification requires an assessment by a CMMC Third-Party Assessment Organization (C3PAO). Hound Shield prepares you for this assessment by running continuous self-assessments aligned to official scoring methodology." },
