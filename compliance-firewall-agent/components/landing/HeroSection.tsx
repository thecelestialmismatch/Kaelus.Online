...
function LiveCounter() {
  ...
  }, [blocked !== null]); // eslint-disable-line react-hooks/exhaustive-deps
      ...
      <div className="relative z-10 w-full max-w-7xl mx-auto px-6 py-28 lg:py-36">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-start">
          ...
          <div>
            ...
            >
              Stop your team from<br />leaking CUI to ChatGPT.
              <br />
            ...
            >
              Hound Shield sits inline between your team and every AI tool —
              scanning every prompt for CUI, PHI, PII, and secrets in under 10ms,
            ...
            >
              <Link
                href="/signup"
                className="inline-flex items-center justify-center gap-2 px-7 py-3.5 bg-[#F5C842] hover:bg-[#e8b830] text-[#07070b] font-semibold rounded-xl transition-all hover:-translate-y-0.5 hover:shadow-[0_8px_28px_rgba(245,200,66,0.3)] text-[15px]"
              >
