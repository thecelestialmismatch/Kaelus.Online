...
export function AgentBuilder({
  ...
  return (
    <div className="space-y-6">
      {/* Notification */}
      {notification && (
        <div className="flex items-center gap-2 p-3 rounded-lg bg-emerald-500/100/10 border border-emerald-500/20 text-emerald-400 text-sm animate-fade-in-up">
          ...
          {templates.map((t, i) => {
            ...
            return (
              ...
              >
                ...
                <h4 className="text-[11px] font-medium text-slate-200 group-hover:text-white transition-colors">
                  {t.name}
                </h4>
              ...
              <div key={agent.id} className="glass-card p-5 hover:border-white/15 transition-all group">
                <div className="flex items-start justify-between mb-3">
                  ...
                  <div className="flex items-center gap-1 opacity-0 group-hover:opacity-100 transition-opacity">
                    <button onClick={() => startEdit(agent)} className="p-1.5 rounded-lg hover:bg-white/10 text-slate-400 hover:text-slate-300 transition-all" title="Edit">
                      <Edit3 className="w-3.5 h-3.5" />
                    </button>
                    <button onClick={() => deleteAgent(agent.id)} className="p-1.5 rounded-lg hover:bg-red-500/20 text-slate-400 hover:text-red-400 transition-all" title="Delete">
                ...
                <p className="text-xs text-slate-400 mb-2 line-clamp-2">{agent.description}</p>
                ...
                <div className="flex items-center gap-2">
                  ...
                  <button
                    ...
                    className={`px-3 py-2 rounded-lg text-xs font-medium transition-all ${agent.isActive
                      ? "bg-emerald-500/100/10 border border-emerald-500/20 text-emerald-400"
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
          ...
          <div className="relative w-full max-w-lg glass-card p-6 space-y-4 max-h-[90vh] overflow-y-auto">
            <div className="flex items-center justify-between">
              ...
              <button onClick={() => setShowModal(false)} className="text-slate-400 hover:text-slate-400 transition-colors">
                <X className="w-5 h-5" />
              </button>
            </div>
            ...
            <div>
              <label className="block text-[11px] font-medium text-slate-400 mb-1.5">Description</label>
              <input
            ...
            <div>
              <label className="block text-[11px] font-medium text-slate-400 mb-1.5">System Prompt</label>
              <textarea
            ...
            {/* Tools Selection */}
            <div>
              <label className="block text-[11px] font-medium text-slate-400 mb-1.5">Tools</label>
            ...
            <div className="flex gap-3">
              <div className="flex-1">
                <label className="block text-[11px] font-medium text-slate-400 mb-1.5">Model</label>
                <select
                  value={form.model}
              ...
              <div className="w-28">
                <label className="block text-[11px] font-medium text-slate-400 mb-1.5">Temperature</label>
                <input
                  type="number"
                  min="0"
                  max="2"
