# Hound Shield — Auth Integrations

Route all AI calls through the Hound Shield proxy to enforce SOC 2, HIPAA, and CMMC Level 2 simultaneously across your Auth stack.
